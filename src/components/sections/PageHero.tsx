...
export function PageHero({ title, subtitle }: PageHeroProps) {
  return (
    <section className="relative bg-gradient-to-br from-charcoal via-charcoal to-charcoal/90 py-16 md:py-20 overflow-hidden">
      ...
      <Container>
        <ScrollReveal>
          <h1 className="text-3xl font-bold text-white md:text-4xl text-center mb-3 relative">
            {title}
          </h1>
          {subtitle && (
